...
$(function () {
  var table = $('#ddd').DataTable({
    ...
    columns: [{
      ...
      data: 'ramassage_avant',
      name: 'ramassage_avant'
    }, {
      data: 'livraison',
      name: 'livraison'
    }, {
      data: 'livraison_avant',
      ...
      data: 'etat',
      render: function render(id, type, row) {
        if (row.etat === 0) {
        ...
        if (row.etat === 2) {
          return "<span class=\"badge badge-info\">valid\xE9 en attened de votre confirmation</span>";
        }

        if (row.etat === 3) {
          return "<span class=\"badge badge-info\">valid\xE9</span>";
        }
    ...
    columns: [{
      ...
      render: function render(id, type, row) {
        if (row.etat === 1 || row.etat === 4) {
          return "<form method=\"POST\" action=\"/dashboard/admin_create\" id=\"form".concat(row.id, "\">\n                <input id=\"token\" type=\"hidden\" name=\"_token\" value=\"") + token.value + "\" />\n                <input type=\"text\" class=\"w-28 rounded-xl\" name=\"prix\">\n                <input type=\"text\" name=\"id\" value=\"".concat(row.id, "\" style=\"display: none;\">\n\n               </form>");
        } else {
          return "<div class=\"rounded-xl bg-info\" >".concat(row.prix, "\u20AC</div>");
        }
      }
    }, {
      data: 'action',
